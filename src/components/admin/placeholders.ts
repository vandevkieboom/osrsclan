...
export const PLACEHOLDER_USERS: AdminUser[] = [
  {
    ...
    username: "izjordy",
    globalName: "izJordy",
    runescapeName: "izJordy",
    avatarUrl: null,
    isAdmin: true,
    team: { id: 1, name: "Crimson Fang" },
  },
  {
    id: 2,
    username: "test_user_two",
    globalName: "Test User Two",
    runescapeName: null,
    avatarUrl: null,
    isAdmin: false,
    team: null,
...
export const PLACEHOLDER_TILES: AdminTile[] = [
  ...
  },
  {
    ...
    iconUrl:
      "https://oldschool.runescape.wiki/images/Scythe_of_vitur_detail.png",
    requiredCount: 1,
    category: "ITEM DROP",
    description: "",
    itemIds: [22325],
