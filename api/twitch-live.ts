...
// Set TWITCH_CLIENT_ID, TWITCH_CLIENT_SECRET, and TWITCH_CHANNELS (comma-separated
// Twitch usernames) as environment variables in your Vercel project settings.
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Fetch live streams for all configured channels
    ...
    // Cache for 60s, serve stale for 30s
